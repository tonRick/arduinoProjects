...
//In the setup, 14 is another way to call pin A0

//The circuit is the potentiomenter
//5V one side pin, ground the pin on the other side, 
//A0 pin connected to middle

//Start up the board with the Serial monitor
...
void loop() {
//First read the pin A0 (also pin 14)
...
//What happens now? The reading/1023 is less than one for almos
//all numbers. The numbers get trucated to 0, unless the readis is 
