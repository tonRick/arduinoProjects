...
//Code for Mechatronics Spring 2017 beacon board for Goal.
//Beacon board flashes IR led at 1200 and 3000 hz, and controls colors of RGB led

//RGB has reversed logic on Mechatronics Board
...
//Set delay time variables - This varies from Tiny to Tiny

#define delayTime1 63 //delay time on for green (15% on for a nice Orange)
#define delayTime2 368 //delay time off for green (sum of delayTime 1 and 2 for RGB Red)
#define delayTime3 172 // delay time for on off (Blue)
...
//Then wait and turn off the RGB red and IR. Then wait at the end for a 1200 hz signal
...
//If the switch is activated - then we need a blue light and the IR light still at 3000 hz
     { 
