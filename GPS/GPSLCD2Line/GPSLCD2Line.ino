...
/*
  This demonstrates the use of the Sparkfun LCD screen and GPS data
  receiver. Both of these items were purchased at Sparkfun
...
String firstLine = ("First Line Text");
String secondLine = ("Second Line Text");
