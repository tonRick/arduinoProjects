...
boolean lineFound = 0; //has a line Been Found? 
...
void stopMo(){
  digitalWrite(dirPinL,HIGH);//Sets direction to backup a little bit
  digitalWrite(dirPinR,HIGH);//Sets direction to backup a little bit
  digitalWrite(speedPinL,10);
  digitalWrite(speedPinR,10);
  delay(30);
  digitalWrite(dirPinL,LOW);//Sets direction
  digitalWrite(dirPinR,LOW);//Sets direction
  digitalWrite(speedPinL,0);
  digitalWrite(speedPinR,0);
  delay(250);
...
void turnLeft(){
  digitalWrite(dirPinL,LOW);//Sets direction
  digitalWrite(dirPinR,LOW);//Sets direction
  analogWrite(speedPinL,20);
  analogWrite(speedPinR,40);
  delay(5);
}

void findLine(){
  //Serial.println("Find Line Mode");
  {
