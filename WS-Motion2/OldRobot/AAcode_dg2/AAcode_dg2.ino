  ...
  int RM_sig = 5;                            //Pin Right Motor is attahced to
  int LM_speed;                              //Variable for spped of Left Motor
  int RM_speed;                              //Variable for spped of Right Motor
  int Avg_speed = 60;                        //Average (Nominal) speed of the robot
  int IR = 0;                                //Pin Sensor is attahced to
  float Kp = 1.00000;                        //Proportionality constant
  float Kd = 0.00090;                        //Derivative constant
  float Ki = 0.00000;                        //Integral constant
  float LoopTime = 0.05000;                  //Time that the loop takes to run 
  ...
  int Desired = 205;                          //Sensor offset value for perfectly on the line. This is what we want to contol to
