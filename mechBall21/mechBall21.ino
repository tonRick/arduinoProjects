...
#define delayTime 995 // delay time for on off (Blue and Red)
#define delayTime2 795 //delay time off for green
#define delayTime3 200 //delay time on for green
...
//IMPORTANT NOTE: In order for the pullups to remain active, the PORTB pin 4 needs to remain a 1 throughout! 
    if (PINB & (1<<4)){
      ...
      _delay_us(delayTime3);                                           /* wait - tested to give ~20% green so orange is output*/
